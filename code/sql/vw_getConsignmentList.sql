...
AS
SELECT co.consignmentnumber, cu.customernumber, cu.customerfirstname, cu.customerlastname, deliver.street AS deliverstreet,deliver.housenumber AS deliverhousenumber, deliver.zipcode AS deliverzipcode, pickup.street AS pickupstreet, pickup.housenumber AS pickuphousenumber, pickup.zipcode AS pickupzipcode, consignorname FROM consignment co
